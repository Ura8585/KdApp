    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Keyboardconfiguration>(entity =>
        {
            ...
            entity.Property(e => e.Configurationhash)
                .HasColumnType("character varying")
                .HasColumnName("configurationhash");
            ...
            entity.HasOne(d => d.Casesize).WithMany(p => p.KeyboardconfigurationCasesizes)
                .HasForeignKey(d => d.CasesizeId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("keyboardconfigurations_components_fk");

            entity.HasOne(d => d.Keycaps).WithMany(p => p.KeyboardconfigurationKeycaps)
                .HasForeignKey(d => d.KeycapsId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("keyboardconfigurations_components_fk_2");

            entity.HasOne(d => d.Switchtype).WithMany(p => p.KeyboardconfigurationSwitchtypes)
                .HasForeignKey(d => d.SwitchtypeId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("keyboardconfigurations_components_fk_1");
